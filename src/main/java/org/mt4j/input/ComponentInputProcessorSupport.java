...
public class ComponentInputProcessorSupport implements IMTInputEventListener /*, IGestureEventListener*/ {
	...
	private IGestureEventListener associatedComponent;
	 ...
	 */
	public ComponentInputProcessorSupport(JFrame graphicsContext, IGestureEventListener associatedComponent) {
