...
public class RotateEvent extends MTGestureEvent {
	 ...
	 */
	public RotateEvent(IInputProcessor source, int id, Component targetComponent, InputCursor firstFingerMotion, InputCursor secondFingerMotion, Vector3D translationVector, Vector3D rotationPoint, float rotationDegrees) {
