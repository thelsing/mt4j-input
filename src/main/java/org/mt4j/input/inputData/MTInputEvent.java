...
public class MTInputEvent extends MTEvent {
	...
	public MTInputEvent(Object source, Component target) {
	 ...
	 */
	public MTInputEvent(Object source, Component target, boolean bubbles) {
		super(source);
		this.target = target;
     ...
     */
    public void setCurrentTarget(Component target){
