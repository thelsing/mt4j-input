...
public class PanTwoFingerEvent extends PanEvent {
	 ...
	 */
	public PanTwoFingerEvent(IInputProcessor source, int id, Component targetComponent, InputCursor firstFinger, InputCursor secondFinger, Vector3D translationVector) {
